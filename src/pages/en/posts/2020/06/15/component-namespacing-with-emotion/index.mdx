...
It's not exactly [the ✌️ official ✌️ convention](http://getbem.com/naming/) ([you've got different ones in fact](https://en.bem.info/methodology/naming-convention/)) but for some reasons like readability or double-clicking on name to select, this was the convention I used and it worked really well!
...
Nope. It's unpleasant to read now.
...
Well, it's quite obvious as at this moment, `MyComponent` doesn't exist yet.
...
Well, after looking into the github issues of emotion, I found a solution, it's just to create an anonymous function which returns the child!
