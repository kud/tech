...
In [this post](/en/posts/2020/05/10/how-to-edit-a-markdown-in-2020-part-1-zmv), we changed the default extension `.mdx` to `.md` especially in order to be able to use Markdown Editors which sometimes only allow `.md` files.
